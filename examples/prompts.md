...
```text
Use $xiaoning-illustrations 先不要生图。
请分析下面这篇文章哪里值得配图，输出 5 张左右的 shot list。
每张图写清楚：放在哪段后、主题、核心意思、结构类型、小柠在做什么、建议中文标注词。
...
```text
Use $xiaoning-illustrations 生成 8 张小柠 IP 样图。
场景覆盖：产品经理、程序员、测试人员、UI 设计师、自媒体工作者、运营人员、架构师、AI 开发者。
每张单独生成，保持 16:9 横版、纯白背景、清爽手绘、小柠承担核心动作。
```

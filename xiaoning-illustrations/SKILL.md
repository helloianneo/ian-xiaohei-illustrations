---
name: xiaoning-illustrations
description: 生成小柠 IP 风格的中文正文配图。用于中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成“清爽”“干练”“亲和”“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；默认使用小柠 / Xiao Ning 程序员 IP，纯白手绘、少量黄蓝橙批注、清爽有生活感但不幼稚的视觉风格。
---
...
为中文文章设计和生成 16:9 横版正文配图。目标不是做商业插画、PPT 信息图或可爱卡通，而是把文章里的关键判断、流程、结构、状态或隐喻，变成一张清爽、亲和、有创意、可读但不说明书的手绘解释图。

默认视觉 IP 是“小柠 / Xiao Ning”：一位热爱编程的 IT 职场人，圆润大眼、圆框眼镜、双麻花辫、蓝色发夹、柠檬黄衬衫、牛仔蓝背带裤、白色帆布鞋。她细心、乐观、爱学习，有点小迷糊但做事认真。小柠必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/xiaoning-ip.md`：小柠 IP 的形象、性格、动作库和禁忌。
...
- 清爽手绘线稿
- 小柠作为核心动作主体
- 圆框眼镜、双麻花辫、蓝色发夹、柠檬黄衬衫、牛仔蓝背带裤
- 少量黄色/蓝色/橙色/红色中文手写批注
- 大量留白
- 禁止 PPT、商业插画、幼稚可爱、复杂架构、左上角类型标题

不要复刻过往案例。案例只提供风格密度和小柠参与方式，不能直接复用旧构图或旧标注。每次都要从当前文章重新发明一个清爽但有记忆点的隐喻。
...
```text
assets/<article-slug>-xiaoning-illustrations/
```
